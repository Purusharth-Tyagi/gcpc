...
def main():
    ...
    # D's real catalog is the source of truth. seed_catalog.json stays as a
    # fallback for when catalog.json is mid-edit or broken.
    default_cat = ("data/catalog.json" if os.path.exists("data/catalog.json")
                   else "data/seed_catalog.json")
